...
function HydroTrackerDisclosure() {
      ...
      <Disclosure as="div" className="bg-white rounded-xl shadow-md hover:shadow-lg">
        ...
        >
          <DisclosurePanel className="text-sm text-gray-700 bg-white border-t border-l border-r border-gray-400 rounded-b-lg p-4">
            <p className="mb-2">The Hydro Tracker monitors your daily water intake, ensuring you stay hydrated.</p>
            <div className="flex justify-center">
              <Link to="/hydro-track" className="inline-block px-4 py-2 text-white bg-gradient-to-r from-pink-300 to-blue-300 rounded-md shadow-md hover:bg-gradient-to-r hover:from-pink-400 hover:to-blue-400">
                Visit Tracker Info
              </Link>
            </div>
          </DisclosurePanel>
...
export default HydroTrackerDisclosure;
