...
function MealPlannerDisclosure() {
    ...
    <div className="mx-auto w-full max-w-lg">
      <Disclosure as="div" className="bg-white rounded-xl shadow-md hover:shadow-lg">
        ...
        >
          ...
          <IoFastFoodOutline size={20} className='mr-2'/> Meal Planner
          </span>
          <ChevronDownIcon
        ...
        >
          <DisclosurePanel className="text-sm text-gray-700 bg-white border-t border-l border-r border-gray-400 rounded-b-lg p-4">
            <p className="mb-2">The Meal Planner helps you organize and plan your daily meals.</p>
            <div className="flex justify-center">
              <Link to="/meal-planner" className="inline-block px-4 py-2 text-white bg-gradient-to-r from-pink-300 to-blue-300 rounded-md shadow-md hover:bg-gradient-to-r hover:from-pink-400 hover:to-blue-400">
                Visit Tracker Info
              </Link>
            </div>
          </DisclosurePanel>
...
export default MealPlannerDisclosure;
