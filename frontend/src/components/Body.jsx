...
function Body({ isLogged, setIsLogged, isAdmin, setIsAdmin }) {
  return (
        ...
        <Routes>
          ...
          {isLogged ?  (
            <>
              ...
              <Route path="/logout" element={<LogOut isLogged={isLogged} setLogged={setIsLogged}/>} />
            </> ) : (
            <>
              <Route path="/login" element={<LogIn setLogged={setIsLogged}  isAdmin={isAdmin} setIsAdmin={setIsAdmin} />} />
